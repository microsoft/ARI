...
param ([ValidateSet('AzureCloud', 'AzureUSGovernment','AzureChinaCloud')]
    ...
    Function Get-UsageMode() {
        ...
        Write-Host " -Secret <VALUE>          :  Specifies the Secret that is used with the Application ID to connect to Azure as service principal. This parameter requires the -TenantID and -AppId to work. If -CertificatePath is also used the Secret value is not the Application secret but is the Certifcate password. "

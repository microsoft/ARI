...
#>
Function Build-ARIResourceReport {
    Param($Subscriptions,
    $ExtractionRuntime,
    $DefaultPath,
    $Resources,
    ...
    $TotalRes = Build-ARIExcelChart -File $File -TableStyle $TableStyle -PlatOS $PlatOS -Subscriptions $Subscriptions -ExtractionRunTime $ExtractionRuntime -ReportingRunTime $ReportingRunTime -RunLite $RunLite -Overview $Overview -Debug $Debug

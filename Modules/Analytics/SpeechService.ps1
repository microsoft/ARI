...
.Link
https://github.com/microsoft/ARI/Modules/Analytics/SpeechService.ps1
...
Else
{
    ...
    if($SmaResources.SpeechService)
    {

        $TableName = ('SpeechTable_'+($SmaResources.SpeechService.id | Select-Object -Unique).count)
        ...
        $ExcelVar = $SmaResources.SpeechService 

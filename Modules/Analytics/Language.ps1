...
.Link
https://github.com/microsoft/ARI/Modules/Analytics/Language.ps1
...
Else
{
    ...
    if($SmaResources.Language)
    {

        $TableName = ('LanguTable_'+($SmaResources.Language.id | Select-Object -Unique).count)
        ...
        $ExcelVar = $SmaResources.Language 

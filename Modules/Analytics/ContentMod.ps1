...
.Link
https://github.com/microsoft/ARI/Modules/Analytics/ContentModerator.ps1
...
Else
{
    ...
    if($SmaResources.ContentModerator)
    {

        $TableName = ('ContentModTable_'+($SmaResources.ContentModerator.id | Select-Object -Unique).count)
        ...
        $ExcelVar = $SmaResources.ContentModerator 

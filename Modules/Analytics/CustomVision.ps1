...
.Link
https://github.com/microsoft/ARI/Modules/Analytics/CustomVision.ps1
...
Else
{
    ...
    if($SmaResources.CustomVision)
    {

        $TableName = ('CustomViTable_'+($SmaResources.CustomVision.id | Select-Object -Unique).count)
        ...
        $ExcelVar = $SmaResources.CustomVision 

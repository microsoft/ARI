...
.Link
https://github.com/microsoft/ARI/Modules/Analytics/ContentSafety.ps1
...
Else
{
    ...
    if($SmaResources.ContentSafety)
    {

        $TableName = ('ContSafTable_'+($SmaResources.ContentSafety.id | Select-Object -Unique).count)
        ...
        $ExcelVar = $SmaResources.ContentSafety 

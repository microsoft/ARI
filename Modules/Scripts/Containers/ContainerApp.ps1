...
.Link
https://github.com/microsoft/ARI/Modules/Containers/ContainerApp.ps1
...
Else
{
    ...
    if($SmaResources.ContainerApp)
    {
        $TableName = ('ContsTb_'+($SmaResources.ContainerApp.id | Select-Object -Unique).count)
        ...
        $ExcelVar = $SmaResources.ContainerApp 
